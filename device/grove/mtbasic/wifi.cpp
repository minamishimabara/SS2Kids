...
const char* password = "kohtoosuga";
...
void post(WiFiClient *wifiClient, char *host, char *url, char *json) {
...
void post(char *host, char *url, char *json) {
  ...
  post(&wifiClient, host, url, json);
}
void orgpost(char *host, char *url, char *json) {
  WiFiClient wifiClient;
  if (!wifiClient.connect(host, 80)) {
    Serial.println("connection failed");
    return;
...
void postpict(char *host, char *url, char *json) {
  WiFiClient wifiClient;
  if (!wifiClient.connect(host, 80)) {
    Serial.println("connection failed");
    return;
